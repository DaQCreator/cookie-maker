...
configuratorRouter
  ...
  .get('/select-base/:baseName', (req, res) => {
    ...
    // Validation for check added bases
  ...
  .get('/add-addon/:addonName', (req, res) => {
    ...
    // Validation for check added addons
    ...
    // Validation for twice added
    if (addons.includes(addonName)) {
      return showErrorPage(res, `${addonName} is already on your cookie, you can't add it twice.`);
    }
